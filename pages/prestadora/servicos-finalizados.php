                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right dropdown-success">
                                ...
                                <a class="dropdown-item" href="#"><p class="texto-preto">Serviços Finalizados</p></a>
                        </ul>
                    </div>
                    <li class="nav-item">
        ...
        <div class="container">
                    ...
                    <div class="card no-transition">
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-1">
                                ...
                                <li><a class="btn btn-link btn-success" href="#">Serviços Finalizados</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-7 bg-light p-3">
                ...
                $query = "SELECT t1.*, t2.*, t3.*, t5.idCliente, t5.nomeCliente, t6.*, t7.*,t8.*, date_format(dataServico,'%d/%m/%Y') as dtServ, date_format(horaServico,'%H:%i') as hrServ
                            ...
                            WHERE t1.idPrestadora = $dadosPrestadora[id] AND t3.ativo = 1 AND t3.idPrestadora IS NOT NULL AND t1.idStatus = 4 AND aprPrestadora = 1
                        ...
                        if($interval->d == 0){
                            ...
                            <div class='clearfix'></div>
                                    ...
                                    if($servico['aprCliente'] == 0){
                                        echo "<h6 class='badge badge-pill badge-danger font-weight-bold texto-preto float-right mt-3 p-2'>Aguardando Confirmação da Cliente</h6>";
                                    }
                                    if($servico['aprCliente'] == 1){
                                        if($servico['avaliaServico'] == NULL){
                                            echo "<h6 class='badge badge-pill badge-danger font-weight-bold texto-preto float-right mt-3 p-2'>Aguardando Avaliação da Cliente</h6>";
                                        } else {
                                            echo "<h6 class='badge badge-pill badge-success font-weight-bold texto-preto float-right mt-3 p-2'>Finalizado !</h6>";
                                        }
                                    }
                                echo "</div>
                                </div>";
