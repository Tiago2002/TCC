         ...
         <div class="card no-transition">
            <div class="card-body">
               ...
               <ul class="list-unstyled mt-3 mb-1">
                  ...
                  <li><a class="btn btn-link btn-warning" href="#">Serviços Finalizados</a></li>
               </ul>
            </div>
         </div>
      </div>
                 ...
                 if($interval->d == 0){
                     ...
                     <div class='clearfix'></div>
                             ...
                             if($servico['aprCliente'] == 1){
                                 if($servico['avaliaServico'] == NULL){
                                     echo "<h6 class='badge badge-danger font-weight-bold texto-preto float-right mt-3 p-2'>Aguardando Avaliação da Cliente</h6>";
                                 } else {
                                     echo "<h6 class='badge badge-success font-weight-bold texto-preto float-right mt-3 p-2'>Finalizado !</h6>";
                                 }
                             }
                         echo "</div>
                         </div>";
