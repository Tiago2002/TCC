                ...
                <div class="row">
                        ...
                        <div class="mb-3 mt-3 mx-auto">
                            <ul class="nav nav-tabs">
                                <li class="row mb-2 mr-auto ml-auto">
                                    ...
                                    <a class="btn btn-outline-primary btn-round m-1" data-toggle="tab"
                                        href="#hidraulica">
                                ...
                                <li class="row mb-2 mr-auto ml-auto">
                                    ...
                                    <a class="btn btn-outline-danger btn-round m-1" data-toggle="tab"
                                        href="#instalacao">
                    ...
                    <div class="col-md-8 mx-auto">
                        <div class="tab-content">
                            <div id="eletrica" class="tab-pane text-center fade">
                                    <?php
                              criarConteudoCardServico(1, "warning ");
                              ?>
                            </div>
                            <div id="hidraulica" class="tab-pane text-center fade">
                                    <?php
                              criarConteudoCardServico(2, "primary ");
                              ?>
                            </div>
                            <div id="pintura" class="tab-pane text-center fade">
                                <?php
                           criarConteudoCardServico(3, "success ");
                           ?>
                            </div>
                            <div id="instalacao" class="tab-pane text-center fade">
                                <?php
                           criarConteudoCardServico(4, "danger ");
                           ?>
                            </div>
                            <div id="montagem" class="tab-pane text-center fade">
                                    <?php
