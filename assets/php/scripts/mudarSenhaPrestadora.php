...
if(isset($_POST['email'])){
    ...
    $sql = "SELECT nomePrestadora, emailPrestadora FROM Prestadoras WHERE emailPrestadora = '$email'";
    ...
    if(mysqli_fetch_row($data)){
        ...
        $sqlTrocaSenha = $conexao->query("UPDATE Prestadoras SET senhaPrestadora = '$senhaCriptografada' WHERE emailPrestadora = '$email'");
